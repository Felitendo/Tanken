  ...
  <div class="tab-view active" id="view-map">
      ...
      <div id="map-search-wrapper">
        ...
        <div id="map-route-panel" class="map-route-panel hidden" role="region" aria-label="Routenplanung">
          <div class="map-route-row">
            <span class="map-route-dot map-route-dot-start" aria-hidden="true"></span>
            <div class="map-route-input-wrapper">
              <input type="text" id="map-route-start-input" class="map-route-input" data-i18n-placeholder="routeStartPlaceholder" placeholder="Start (aktueller Standort)" autocomplete="off" />
              <div id="map-route-start-results" class="map-route-suggest hidden" role="listbox"></div>
            </div>
          </div>
          <div class="map-route-row">
            <span class="map-route-dot map-route-dot-dest" aria-hidden="true"></span>
            <div class="map-route-input-wrapper">
              <input type="text" id="map-route-dest-input" class="map-route-input" data-i18n-placeholder="routeDestPlaceholder" placeholder="Ziel" autocomplete="off" />
              <div id="map-route-dest-results" class="map-route-suggest hidden" role="listbox"></div>
            </div>
          </div>
          <div class="map-route-actions">
            <button id="map-route-close" type="button" class="map-route-close" data-i18n="cancel">Abbrechen</button>
            <button id="map-route-go" type="button" class="map-route-go" disabled>
              <span data-i18n="routeGo">Route finden</span>
            </button>
          </div>
          <div id="map-route-summary" class="map-route-summary hidden" role="status"></div>
        </div>
      </div>
    ...
    <div class="desktop-station-panel">
      <div class="station-sort-bar">
        <div class="station-sort-actions">
          <button type="button" class="station-fav-btn" id="station-fav-toggle" data-i18n-title="favouritesToggleTitle" data-i18n-aria-label="favouritesToggleTitle" title="Favoriten oben anzeigen" aria-label="Favoriten oben anzeigen" aria-pressed="false">
            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
          </button>
          <button type="button" class="station-fav-btn" id="station-group-toggle" data-i18n-title="groupByPriceTitle" data-i18n-aria-label="groupByPriceTitle" title="Pro Preis nur die nächste Tankstelle" aria-label="Pro Preis nur die nächste Tankstelle" aria-pressed="false">
            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true"><path d="M11.99 18.54l-7.37-5.73L3 14.07l9 7 9-7-1.63-1.27-7.38 5.74zM12 16l7.36-5.73L21 9l-9-7-9 7 1.63 1.27L12 16z"/></svg>
          </button>
          <button type="button" class="station-fav-btn" id="station-fav-filter" data-i18n-title="favouritesOnlyTitle" data-i18n-aria-label="favouritesOnlyTitle" title="Nur Favoriten anzeigen" aria-label="Nur Favoriten anzeigen" aria-pressed="false">
            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true"><path d="M10 18h4v-2h-4v2zM3 6v2h18V6H3zm3 7h12v-2H6v2z"/></svg>
          </button>
          <span class="sync-badge station-fav-sync" data-sync-key="favouritesOnTop groupByPrice favouritesOnly" data-i18n-title="syncedSetting" title="Wird zwischen Geräten synchronisiert"><svg class="sync-icon-idle" viewBox="0 0 24 24" width="13" height="13" fill="currentColor"><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z"/></svg><svg class="sync-icon-spin" viewBox="0 0 24 24" width="13" height="13" fill="currentColor"><path d="M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z"/></svg><svg class="sync-icon-ok" viewBox="0 0 24 24" width="13" height="13" fill="currentColor"><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM10 17l-3.5-3.5 1.41-1.41L10 14.17l5.09-5.09L16.5 10.5 10 17z"/></svg></span>
        </div>
